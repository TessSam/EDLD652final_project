...
library(ez)
library(effects)
library(grDevices) # added this since it couldn't find the `quartz()` function but then it still didn't work, I suspect b/c I have windows OS
```
...
#grDevices::quartz(width=5,height=4) # i think this code is not reproducible for people with Windows OS

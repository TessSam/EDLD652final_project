...
#J: Maybe consider using code folding in your global options and repressing some of the messages
# that are currently popping up to aid in readability. It's really helpful to  be able to see the
# code but the first go-through I was initially a bit confused.
```
...
library(foreign)
library(gridExtra)
library(tidyverse) #J: I condensed dplyr, tidyr, and ggplot2 into a single load for tidyverse
library(lme4)
...
#J: A lot of these packages are new to me, I'm really excited to see how you use them!
...
#J: This is my first time seeing how data can be scrambled, really helpful!
...
#J: Ooh, ezANOVA is a new function for me--looks handy!
...
#J: I really like that you comment where your aesthetic mappings start, I'm going to borrow that
...
```{r Some comments}
# Viz 1: 
# I'm a bit confused looking at your first plot, mainly just because I don't fully understand what the project is, so I'm excited for your presentation to get a little more context. I don't know if it would potentially warp what you're trying to convey, but I wonder if using {cowplot} or something similar to staple the effect plots together with shared axes might aid readability and reduce repetition of axes.

# Viz 2:
# Really nice and clear! I like the minimalist look in this plot a lot, and especially like how you incorporated the legend into the plot itself so it's all in one space. 

# Viz 3:
# Like plot 2, really nice and clear! I like the black and red look together. It's easy to read and nice that it matches the second plot. The only room for improvement here I see is with the title. Maybe using latex for "R^2" and moving everything after "Correlations of Cueing Congruency" to a second line? I didn't play with it in this fork because the way it's set up (with paste0) is unfamiliar to me and I was afraid it might mess something up.
